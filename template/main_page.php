...
<body>
  <div class="main_block main_page_left">
      ...
      <div id="checkboxes" class="category_filter_section">
        ...
        <?php  
			...
			foreach ($category_shortname_array as $name => $shortname)  {
              ...
              <img class="cat_icon" style="height: 20px; width: 20px; margin-right: 2px;"  src="'.$category_icon_src.'"/><label class="cat_label" for="'.$category_shortname.'">'. $name .'</label></div>';
					}
