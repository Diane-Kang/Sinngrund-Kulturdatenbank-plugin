    ...
    <div class="popup info " id="geeting_info_popup">
        ...
        <div class="content_wrapper">
            ...
            <div class="slide one show">
                <div class="left">
                    <h2><span class="d_blue">Willkommen in der</span><span class="l_blue">Kulturdatenbank
                            Sinngrund</span>
                    </h2>
                    <p>
            ...
            <div class="slide two">
                ...
                <p>
                    Jedes Symbol auf der Karte steht für einen Eintrag in der Kulturdatenbank. Die unterschiedlichen
                    Symbole stehen für verschiedene Kategorien, z.B. Wanderwege oder Sehenswürdigkeiten. Klicken Sie auf
                    ein Symbol, um zum entsprechenden Detailartikel zu kommen.
                </p>
            ...
            <div class="slide three">
                ...
                <img src="/wp-content/plugins/Sinngrund-Kulturdatenbank-plugin/assets/screen222.jpeg"
                    alt="Screenshot zur Bedienung der Datenbank: Übersichtsseite">
                <p>
                    Die Liste bildet alle Einträge analog zur Kartendarstellung ab. Mithilfe der Suchmaske können
                    bestimmte
            ...
            <div class="slide four">
                ...
                <img src="/wp-content/plugins/Sinngrund-Kulturdatenbank-plugin/assets/screen_two.jpeg"
                    alt="Screenshot zur Bedienung der Datenbank: Übersichtsseite">
                <p>
                    Um nur bestimmte Kategorien anzuzeigen, können diese über das Filtermenü ein- oder ausgeblendet
                    werden. Ist kein Haken gesetzt, werden automatisch alle Symbole angezeigt.
                </p>
                <div class="botton_row">
                    <button class="prev" aria-label="Vorige Folie">Zurück</button>
                    <a class="mitmachen button" target="_blank" href="<?php echo site_url("zugang") ?>">Mitmachen</a>
